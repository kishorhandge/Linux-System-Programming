/*
    ...
    --> Uses write() to write data and syncfs() to flush filesystem buffers for this file descriptor.
    --> Error handling is done using errno and strerror().
*/

#include<stdio.h>                                   // For printf()
#include<unistd.h>                                  // For write(), close(), and syncfs()
...
int main()
{
    ...
    syncfs(fd);                                                 // Flush filesystem buffers for this file descriptor (OS-specific)
